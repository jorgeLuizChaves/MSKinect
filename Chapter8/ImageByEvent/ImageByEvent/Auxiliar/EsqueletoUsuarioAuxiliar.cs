...
namespace ImageByEvent.Auxiliar
{
    public class EsqueletoUsuarioAuxiliar
    {
        ...
        public Ellipse DesenharArticulacao(Joint articulacao, Canvas canvasParaDesenhar)
        {
            ...
            ConfiguraComponenteVisualArticulacao(objetoArticulacao, diametroArticulacao, larguraDesenho, corDesenho);
        ...
        public void DesenharOsso (Joint articulacaoOrigem, Joint articulacaoDestino, Canvas canvasParaDesenhar)
        {
            ...
            ColorImagePoint posicaoArticulacaoOrigem = ConverterCoordenadasArticulacao(articulacaoOrigem, 
                                                                                        canvasParaDesenhar.ActualWidth, 
                                                                                        canvasParaDesenhar.ActualHeight);
            ColorImagePoint posicaoArticulacaoDestino = ConverterCoordenadasArticulacao(articulacaoDestino, 
                                                                                        canvasParaDesenhar.ActualWidth, 
                                                                                        canvasParaDesenhar.ActualHeight);
            Line objetoOsso = CriarComponenteVisualOsso(larguraDesenho, 
                                                        corDesenho,posicaoArticulacaoOrigem.X, 
                                                        posicaoArticulacaoOrigem.Y,
                                                        posicaoArticulacaoDestino.X, 
